...
export type FieldType = "text" | "textarea" | "number" | "currency" | "boolean" | "select" | "status" | "multiselect" | "date" | "datetime" | "email" | "phone" | "relation" | "formula" | "rating" | "user" | "tags" | "url" | "checklist";
...
export type WidgetType = "metric" | "list" | "board_summary" | "activity_feed" | "saved_view" | "goal_progress" | "funnel_pace" | "gap_analysis" | "today_summary" | "daily_actions_list" | "prospecting_summary" | "connection_rate" | "hot_leads" | "followups_due" | "active_call_session" | "execution_score" | "talk_to_pace" | "partner_growth" | "projected_closings" | "projected_income" | "partner_health" | "pace_forecast" | "weekly_scorecard";
  ...
  public: {
    Tables: {
      ...
      field_requirements: {
        ...
        Update: Partial<Omit<Database["public"]["Tables"]["field_requirements"]["Insert"], "id" | "organization_id">>;
      };
      field_values: {
        Row: {
          id: string;
